...
def get_letterboxd_url():
    while True:
        # Applying multiple colors to different sections of the line
        print(colored_text("─" * 10, "#fb8304") +
                          colored_text("─" * 10, "#04e354") +
                          colored_text("─" * 10, "#43bbf3") +
                          colored_text("─" * 10, "#cacdcc"))

        print(colored_text("Enter your Letterboxd username: ", "#FFD700"))
        username = input()
        print(colored_text("─" * 10, "#cacdcc") +
                          colored_text("─" * 10, "#43bbf3") +
                          colored_text("─" * 10, "#04e354") +
                          colored_text("─" * 10, "#fb8304"))
        ...
        try:
            ...
            print(colored_text(f"\n⛔❗⚠️  Error accessing the page. Please check your internet connection and try again.📶🤷\n🏻‍", "#FF0000", "#FFCCCC"))
...
def main_menu():
    while True:
        ...
        print(colored_text(separator, "#fb8304"))
        print(colored_text(separator, "#04e354"))
        print(colored_text(separator, "#43bbf3"))
        print(colored_text(separator, "#cacdcc"))
        print(colored_text("\n╔═══════════════════════════════════════════════╗", "#4d4dae", "#000000"))
        print(colored_text("   Welcome to the Letterboxd History Exporter!   ", "#FF69B4", "#00008B"))
        print(colored_text("╚═══════════════════════════════════════════════╝", "#4d4dae", "#000000"))
        print(colored_text("\n1. Start Crawling Watched Movies", "#32CD32"))
        print(colored_text("2. Export Watched Movies to CSV", "#00CED1"))
        print(colored_text("3. Exit", "#DC143C"))
        
        choice = input(colored_text("\nChoose an option: ", "#FFD700"))
        ...
        if choice == '1':
            ...
            print(colored_text("Movies successfully crawled!🕵", "#32CD32"))
            input(colored_text("Press Enter to return to the main menu...", "#A9A9A9"))
        elif choice == '2':           
            print(colored_text("─" * 10, "#fb8304") +
                              colored_text("─" * 10, "#04e354") +
                              colored_text("─" * 10, "#43bbf3") +
            ...
            print(colored_text("─" * 10, "#fb8304") +
                          ...
                          colored_text("─" * 10, "#43bbf3") +
                          colored_text("─" * 10, "#cacdcc"))
            print(colored_text("  Exiting...🚪🏃   Goodbye! 👌", "#87CEEB"))
            print(colored_text("─" * 10, "#cacdcc") +
                          colored_text("─" * 10, "#43bbf3") +
                          colored_text("─" * 10, "#04e354") +
                          colored_text("─" * 10, "#fb8304"))
            ...
            print(colored_text("❌ Invalid choice! Please choose again.", "#FF6347", "#FFFFE0"))
            input(colored_text("Press Enter to continue...", "#A9A9A9"))
